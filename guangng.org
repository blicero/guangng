...
# Time-stamp: <2026-02-03 18:19:46 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2026-02-03 Di 18:19]
   | Headline                                      | Time      |            |       |      |
   |-----------------------------------------------+-----------+------------+-------+------|
   | *Total time*                                  | *2d 5:49* |            |       |      |
   |-----------------------------------------------+-----------+------------+-------+------|
   | *GuangNG [13/17]*                             | *2d 5:49* |            |       |      |
   | \_  /Components [4/5]/                        |           | /1d 23:28/ |       |      |
   | \_    Main [0/0]                              |           |            |  0:15 |      |
   | \_    Model [0/0]                             |           |            |  1:37 |      |
   | \_    Database [1/1]                          |           |            |  6:14 |      |
   ...
   | \_      XFR                                   |           |            |       | 0:07 |
   | \_      Scanner                               |           |            |       | 0:14 |
   | \_    Control starting/stopping subsystems... |           |            |  4:59 |      |
   | \_      Web                                   |           |            |       | 2:39 |
   | \_  /Bugs [2/3]/                              |           | /0:39/     |       |      |
...
**** TODO Handle counting workers more professionally
     :LOGBOOK:
...
**** DONE Scanner
     ...
     :END:
*** TODO Control starting/stopping subsystems [3/4]            :internals:ui:
    :PROPERTIES:
    :COOKIE_DATA: todo recursive
    :VISIBILITY:
    :END:
