...
# Time-stamp: <2026-01-22 18:48:42 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2026-01-22 Do 18:48]
   | Headline                                  | Time      |           |      |      |
   |-------------------------------------------+-----------+-----------+------+------|
   | *Total time*                              | *1d 2:09* |           |      |      |
   |-------------------------------------------+-----------+-----------+------+------|
   | *GuangNG [0/0]*                           | *1d 2:09* |           |      |      |
   | \_  /Components [0/0]/                    |           | /1d 1:56/ |      |      |
   | \_    Main [0/0]                          |           |           | 0:15 |      |
   | \_    Model [0/0]                         |           |           | 1:37 |      |
   | \_    Database [0/1]                      |           |           | 4:31 |      |
   | \_      Add queries/methods for services  |           |           |      | 1:56 |
...
*** Database [0/1]
    ...
    :END:
**** TODO Add queries/methods for services
     :LOGBOOK:
